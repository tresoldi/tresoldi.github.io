...
title: "About"
permalink: "/about/"
subtitle: "Tiago Tresoldi — a short account"
description: "About Tiago Tresoldi: computational historical linguist, software author, and recovering classicist in Uppsala, Sweden."
---
...
approaches that let phonological information (sound correspondences, inferred sound
changes) do real work. In my day job I take that same toolkit — large structured data,
pattern detection, rigorous hypothesis testing — and point it at why a booking system is
failing or what is driving customer contacts.

My Ph.D. examined the *classical* as a means of relationship with otherness, told through
the literary afterlives of Odysseus. Fitting, since I have been wandering between
disciplines ever since — literature to linguistics to data science — still not quite sure
whether I am heading back to Ithaca or merely circling. Let us hope I do not end up like
Dante's Ulysses, sailing past the pillars for the sake of one more intellectual adventure.

## Positions

- **Insight Analyst** — Etraveli, Uppsala · 2024–present
- **Affiliate Researcher** — Linguistics and Philology, Uppsala University · 2023–present
...
- **B.A., Italian Language and Culture** — ICoN / Università di Pisa, Italy · 2008
  *Hidden Markov Models and other approaches to tagging Italian.*
